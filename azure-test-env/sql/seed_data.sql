...
-- Payers
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM payers WHERE name = 'Anthem Blue Cross')
...
-- Providers
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM providers WHERE npi = '1234567890')
...
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM patients WHERE first_name = 'John' AND last_name = 'Smith')
...
IF NOT EXISTS (SELECT 1 FROM fee_schedule WHERE payer_id = 1 AND cpt_code = '99283' AND valid_from = '2024-01-01')
...
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM claims WHERE external_claim_id = 'CLM-2025-0001')
...
-- Claim Lines
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM claim_lines WHERE claim_id = 1 AND line_number = 1)
...
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM remittances WHERE check_number = 'CHK-10001')
...
-- Cases
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM cases WHERE assigned_analyst = 'Ana Rodriguez' AND created_date = '2025-08-01')
...
-- Disputes
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM disputes WHERE claim_id = 1 AND case_id = 1)
...
-- Evidence Artifacts
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM evidence_artifacts WHERE case_id = 1 AND type = 'eob')
...
-- Deadlines
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM deadlines WHERE case_id = 1 AND type = 'open_negotiation')
...
-- ============================================================================
IF NOT EXISTS (SELECT 1 FROM audit_log WHERE entity_type = 'case' AND entity_id = '1' AND action = 'insert')
